...
def test_format():
    ...
    time_obj = dt.time(12, 30, 45)
    datetime_obj = dt.datetime(2025, 2, 1, 12, 30, 45)  # noqa: DTZ001
    datetime_with_tz_obj1 = dt.datetime(2025, 2, 1, 12, 30, 45, tzinfo=local_tz)
    datetime_with_tz_obj2 = dt.datetime(2025, 2, 1, 12, 30, 45, tzinfo=utc_tz)
    ...
    test_str1 = DateHelper.format(datetime_with_tz_obj1)
    test_str2 = DateHelper.format(datetime_with_tz_obj2)
    return
    # assert test_str == "2025-02-01 12:30:45", "Formatted datetime with tz should be '2025-02-01 12:30:45'"

    # Test the ISO format
    assert DateHelper.format(date_obj, "ISO") == "2025-02-01", "ISO formatted date should be '2025-02-01'"
    assert DateHelper.format(time_obj, "ISO") == "12:30:45", "ISO formatted time should be '12:30:45'"
    assert DateHelper.format(datetime_obj, "ISO") == "2025-02-01T12:30:45+0000", "ISO formatted datetime should be '2025-02-01T12:30:45+0000'"
    assert DateHelper.format(datetime_with_tz_obj, "ISO") == "2025-02-01T12:30:45+0000", "ISO formatted datetime with tz should be '2025-02-01T12:30:45+0000'"
